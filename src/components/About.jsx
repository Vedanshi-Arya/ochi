  ...
  return (
    ...
    >
      ...
      <div className="grid gap-y-30 md:grid-cols-12 py-15 outline-top mb-40 md:mb-90 mt-32 border-t-[1px] pt-[1vw]  border-[#a1b562]">
        <div className="md:col-span-4 pt-5 lg:col-span-6 reset-last font-medium">
          <p>What you can expect:</p>
        </div>
        <div className="md:col-span-4 lg:col-span-4 reset-last">
          <div className="wysiwyg pt-5 reset-last max-w-275">
            <p>
      ...
      <div className="w-full flex  gap-5 border-t-[1px] pt-[1vw] mt-[2vw] border-[#a1b562] ">
        <div className="w-full">
          ...
          <button className="flex mt-6 gap-10 items-center text-[2vw] px-8 py-3 bg-zinc-900 mt-[1vw] rounded-full text-white">
            Read More
